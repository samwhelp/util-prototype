...
class App:
	...
	uri_default = 'https://www.youtube.com'
	...
	keybind_accelerator_name_play_youtube = 'F5'
	...
	def init_menu (self):
		...
		item = Gtk.MenuItem.new_with_label('使用mpv播放 (%s)' % self.keybind_accelerator_name_play_youtube)
	...
	def go_play_youtube (self):
		...
		#subprocess.Popen(('mpv', '--ytdl', uri))
		subprocess.Popen(('mpv', '--ytdl', '--ytdl-format=best' , uri))
